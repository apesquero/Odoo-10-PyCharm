...
class StockPicking(models.Model):
        ...
        for picking in self:
            ...
            for move in picking.move_lines:
                ...
                if float_compare(forced_qty, 0, precision_rounding=move.product_id.uom_id.rounding) > 0:
                    #TODO: Crear aquí la diferencia entre los productos con distinto ancho y alto
    ...
    def _prepare_pack_ops(self, quants, forced_qties):
        ...
        #AP: We eliminate the possibility of grouping the products
        # TODO: pendiente de modificar _get_top_level_packages
        # top_lvl_packages = valid_quants._get_top_level_packages(computed_putaway_locations)
        top_lvl_packages = valid_quants
        ...
        for mapping, qty in qtys_grouped.items():
            ...
            val_dict = {
                ...
                #TODO: Pendiente de modificar al valor correcto, es posible que se solucione si creo un solo valor
