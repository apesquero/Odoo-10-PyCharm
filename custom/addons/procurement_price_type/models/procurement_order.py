...
class ProcurementOrder(models.Model):
    ...
    def _prepare_purchase_order_line(self, po, supplier):
        self.ensure_one()
        res = super(ProcurementOrder, self)._prepare_purchase_order_line(po=po,
                                                                         supplier=supplier)
        ...
        for procurement in self:
            ...
            for line in po.order_line:
                ...
                if line.product_id == product_id \
                        ...
                        and line.origin_width == procurement.origin_width \
                        and line.origin_height == procurement.origin_height:
